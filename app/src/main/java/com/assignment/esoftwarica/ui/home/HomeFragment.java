...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("Bibek", "Budhanilkantha", "Male", "19",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Bibas", "Maharajgunj", "Male", "22", R.drawable.maleimg));
            studentsList.add(new Students("Kretika", "Chabel", "Female", "19", R.drawable.femaleimg));
